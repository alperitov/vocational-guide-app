...
mixin _$Course {
 ...
 String get id; String get nome; String get area; List<String> get dimensoesRiasec; List<String> get instituicoes; String get descricao;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nome,area,const DeepCollectionEquality().hash(dimensoesRiasec),const DeepCollectionEquality().hash(instituicoes),descricao);

@override
String toString() {
  return 'Course(id: $id, nome: $nome, area: $area, dimensoesRiasec: $dimensoesRiasec, instituicoes: $instituicoes, descricao: $descricao)';
}
...
@useResult
$Res call({
 String id, String nome, String area, List<String> dimensoesRiasec, List<String> instituicoes, String descricao
});
...
/// Create a copy of Course
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? nome = null,Object? area = null,Object? dimensoesRiasec = null,Object? instituicoes = null,Object? descricao = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String nome,  String area,  List<String> dimensoesRiasec,  List<String> instituicoes,  String descricao)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Course() when $default != null:
return $default(_that.id,_that.nome,_that.area,_that.dimensoesRiasec,_that.instituicoes,_that.descricao);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String nome,  String area,  List<String> dimensoesRiasec,  List<String> instituicoes,  String descricao)  $default,) {final _that = this;
switch (_that) {
case _Course():
return $default(_that.id,_that.nome,_that.area,_that.dimensoesRiasec,_that.instituicoes,_that.descricao);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String nome,  String area,  List<String> dimensoesRiasec,  List<String> instituicoes,  String descricao)?  $default,) {final _that = this;
switch (_that) {
case _Course() when $default != null:
return $default(_that.id,_that.nome,_that.area,_that.dimensoesRiasec,_that.instituicoes,_that.descricao);case _:
  return null;
...
class _Course implements Course {
  const _Course({required this.id, required this.nome, required this.area, required final  List<String> dimensoesRiasec, required final  List<String> instituicoes, required this.descricao}): _dimensoesRiasec = dimensoesRiasec,_instituicoes = instituicoes;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nome,area,const DeepCollectionEquality().hash(_dimensoesRiasec),const DeepCollectionEquality().hash(_instituicoes),descricao);
...
/// Create a copy of Course
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? nome = null,Object? area = null,Object? dimensoesRiasec = null,Object? instituicoes = null,Object? descricao = null,}) {
