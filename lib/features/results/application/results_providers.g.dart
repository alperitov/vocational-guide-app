...
String _$combinedProfileHash() => r'cac780de92addb1dc7b42aea2b9238997cd5ad4c';

/// See also [combinedProfile].
@ProviderFor(combinedProfile)
final combinedProfileProvider =
    AutoDisposeFutureProvider<CombinedProfile>.internal(
      combinedProfile,
      name: r'combinedProfileProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$combinedProfileHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef CombinedProfileRef = AutoDisposeFutureProviderRef<CombinedProfile>;
